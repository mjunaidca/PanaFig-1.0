...
const StatesScreen = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row sm:flex-row py-10 lg:py-20 px-4'>
            ...
            <div className='sm:basis-[80%] w-full flex flex-wrap gap-5'>
                {tabData?.Data.map((item) => (
                    <div key={item.title} className={` border-red-600 border-l-4 py-3 px-2 h-auto max-h-[80%] bg-gray-100 hover:shadow-lg rounded-r-2xl md:basis-1/3 lg:basis-1/4 w-full flex flex-col justify-around`}>
